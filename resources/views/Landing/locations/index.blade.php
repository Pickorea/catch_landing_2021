                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover mx-0 display" id="data-table" data-page-length="100"
                               data-order='[[ 0, "desc" ]]' data-href="{{ route("location.datatables") }}">
                            <thead>
                            <tr>
                                <th>Title</th>
                                <th>Created at</th>
                                <th width="80px">
                                    <a href="{{ route('location.create') }}"><i class="fas fa-plus"></i>+</a>
                                </th>
                            </tr>
                            </thead>
                            <tbody>
                    ...
                    columnDefs: [
                        {
                            "render": function ( data, type, row ) {
                                let value = '<a href="{{ route('location.index') }}/'+row['id']+'"><i class="fas fa-eye"></i>View</a>';
                                 if (permissionEdit) {
                                    value += ' <a href="{{ route('location.index') }}/'+row['id']+'/edit"><i class="fas fa-edit"></i>Edit</a>' ;
                                }
                                 return value;
